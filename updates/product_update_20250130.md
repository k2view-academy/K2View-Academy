...
* Fabric has been enhanced with integrated **GenAI** technology, leading to a wider range of product capabilities, such as:
  * **LLM-based Catalog profiling** as a way to identify particular classification of data using an LLM model.
  * **AI Assistant for SQL statements** – a newly built-in AI Assistant within the Query Builder editors, which enables an effortless creation of SQL statements by simply describing the desired query in natural language.
