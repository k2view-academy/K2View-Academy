...
Now that you are able to retrieve and view the data in Fabric, let's see how the data is stored in Cassandra, about the operational information that is displayed and that commands used to access it:
