...
Now that you are able to retrieve and view the data in Fabric, let's see how the data is stored in Cassandra, about the operational information that is displayed and which commands access it:
