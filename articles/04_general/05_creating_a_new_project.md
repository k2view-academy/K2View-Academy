...
1. Go to the **Start Page** or click the **File** icon ![image]https://github.com/k2view-academy/K2View-Academy/blob/master/articles/04_general/images/04_05_01%20New%20Project%20icon.jpg and then click **New Project** to display the **New Project** dialog box.
