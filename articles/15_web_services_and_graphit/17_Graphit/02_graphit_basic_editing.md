...
- Click  <img src="images/drag-open-icon.png" > to expand a collapsed node. When expanded, click it again to collapse a node back. Using this capability lets you from one side, to have an overview of a Graphit file, if it is complex, avoid being over-helmed, and on the other side to deep dive and see the lower level nodes.
