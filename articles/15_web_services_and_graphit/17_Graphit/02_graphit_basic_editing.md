...
- Click  <img src="images/drag-open-icon.png" > to expand a collapsed node. When expanded, click it again to collapse a node back. Using this capability lets you on one hand, to get an overview of a Graphit file, if it is complex, avoid being overwhelmed, and on the other hand to deep dive and see the lower-level nodes.
