...
#### grFormat.graphit
In this example, you will find that all the children nodes of the CRM_DB node are defined as field. The response populates the document with the names and values of these specific field.<br></br>
