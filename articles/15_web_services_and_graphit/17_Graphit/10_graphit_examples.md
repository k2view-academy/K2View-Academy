...
Output from the Swagger GUI for grSQLGldPlus.graphit where the Customer Instance ID = 1234:

<img src="/articles/15_web_services_and_graphit/17_Graphit/images/59_graphit_examples.PNG" width="700" height="400"></img>


Output from the Swagger GUI for grSQLBrz.graphit where the Customer Instance ID = 1000:
...
Note the different tags used and their respective affect on the output CSV document:
...
#### grRaw.graphit
This example illustrates XML output in raw format. Observe the ?xml version="1.0" encoding="UTF-8"... header value displayed in the response. <br></br>
