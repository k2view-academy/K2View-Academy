...
It means if according to users role permission he can not get instance 1 on LU A, he will not be able to do so also inside the Web-Service even if the user can execution the Web-Service.
