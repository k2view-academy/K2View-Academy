## FABRIC V8.0.0_320-HF3 DOCKER INSTALLATION
...
1. Download the latest versions of Fabric, Cassandra and Docker Compose using 1 the below 4 links:
  ...
  <table style="border-collapse: collapse; width: 100%;">
   ...
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.0/Server/fabric-8.0.0_320-HF3/D_k2view_fabric_8.0.0_320.tar.gz
   <br>md5: 1d319937d356bff39f6b9eef50373b06</br></td>
   </tr>
   <tr>
   <td style="width: 50%; height: 18px;"><strong>docker-compose </strong></td>
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.0/Server/fabric-8.0.0_320-HF3/compose_fabric_8.0.0_320.tar.gz
   <br>md5: 7aa2cb9d0c4c862f79fd0d41ffbd2eaf</br></td>
   </tr>
   </tbody>
   </table>
2. Copy all files to the k2view directory as follows: (skip Kafka if not needed)
   ...
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.0/Server/fabric-8.0.0_320-HF3/D_k2view_fabric_8.0.0_320.tar.gz
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.0/Server/fabric-8.0.0_320-HF3/compose_fabric_8.0.0_320.tar.gz 
   ```
3. Load the Docker images as follows: (skip Kafka if not needed)
   ...
   ```bash
    ...
    docker load -i D_k2view_fabric_8.0.0_320.tar.gz 
   ```
...
4. Extract the Config archives as follows:
   ...
   ```bash
   tar -zxvf compose_fabric_8.0.0_320.tar.gz 
   ```
