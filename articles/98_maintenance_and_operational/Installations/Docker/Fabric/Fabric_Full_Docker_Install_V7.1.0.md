## FABRIC V7.1.0_216-HF1 DOCKER INSTALLATION
...
1. Download the latest versions of Fabric, Cassandra, Kafka and Docker Compose using 1 the below 4 links:
  ...
  <table style="border-collapse: collapse; width: 100%;">
   ...
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.1/Server/fabric-7.1.0_216-HF1/D_k2view_fabric_7.1.0_216.tar.gz
   <br>md5: 9b4f9340dc962bad4b486863eb13698d</br></td>
   </tr>
   <tr>
   <td style="width: 50%; height: 18px;"><strong>docker-compose </strong></td>
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.1/Server/fabric-7.1.0_216-HF1/compose_fabric_7.1.0_216.tar.gz
   <br>md5: ccd941a23ee4cc00900aeee3248ae961</br></td>
   </tr>
   </tbody>
   </table>
2. Copy all files to the k2view directory as follows:
   ...
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.1/Server/fabric-7.1.0_216-HF1/D_k2view_fabric_7.1.0_216.tar.gz
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.1/Server/fabric-7.1.0_216-HF1/compose_fabric_7.1.0_216.tar.gz
   ```
3. Load the Docker images as follows:
   ...
   ```bash
    ...
    docker load -i D_k2view_fabric_7.1.0_216.tar.gz 
   ```
...
4. Extract the Config archives as follows:
   ...
   ```bash
   tar -zxvf compose_fabric_7.1.0_216.tar.gz 
   ```
