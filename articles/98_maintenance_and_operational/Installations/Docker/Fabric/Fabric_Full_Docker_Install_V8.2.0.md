## FABRIC V8.2.0_234 DOCKER INSTALLATION
...
1. Download the latest versions of Fabric, Cassandra and Docker Compose using 1 the below 4 links:
  ...
  <table style="border-collapse: collapse; width: 100%;">
   ...
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.2/Server/fabric-8.2.0_234/D_k2view_fabric_8.2.0_234.tar.gz
   <br>md5: 3ac389c7205365010699410527e4b33f</br></td>
   </tr>
   <tr>
   <td style="width: 50%; height: 18px;"><strong>docker-compose </strong></td>
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.2/Server/fabric-8.2.0_234/compose_fabric_8.2.0_234.tar.gz
   <br>md5: 2643a266f71005aabbc0acad1681201c</br></td>
   </tr>
   </tbody>
   </table>
2. Copy all files to the k2view directory as follows: (skip Kafka if not needed)
   ...
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.2/Server/fabric-8.2.0_234/D_k2view_fabric_8.2.0_234.tar.gz
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_8.2/Server/fabric-8.2.0_234/compose_fabric_8.2.0_234.tar.gz 
   ```
3. Load the Docker images as follows: (skip Kafka if not needed)
   ...
   ```bash
    ...
    docker load -i D_k2view_fabric_8.2.0_234.tar.gz 
   ```
...
4. Extract the Config archives as follows:
   ...
   ```bash
   tar -zxvf compose_fabric_8.2.0_234.tar.gz 
   ```
