## FABRIC v6.5.9_220-HF20 DOCKER INSTALLATION
...
1. Download the latest versions of Fabric, Cassandra, Kafka and Docker Compose using the below 4 links:
   ...
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_6.5/6.5.9/Server/fabric-6.5.9_220-HF20/D_k2view_fabric_6.5.9_220.tar.gz
   <br>md5: afc2e919ab9e8ea93c6afd5b3107e6b5</br></td>
   </tr>
   <tr>
   <td style="width: 50%; height: 18px;"><strong>docker-compose </strong></td>
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_6.5/6.5.9/Server/fabric-6.5.9_220-HF20/compose_fabric_6.5.9_220.tar.gz
   <br>md5: 631f7a9e036ddc38c37504bff347104f</br></td>
   </tr>
   </tbody>
   </table>
2. Copy all files to the k2view directory as follows:
   ...
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_6.5/6.5.9/Server/fabric-6.5.9_220-HF20/D_k2view_fabric_6.5.9_220.tar.gz
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_6.5/6.5.9/Server/fabric-6.5.9_220-HF20/compose_fabric_6.5.9_220.tar.gz
   ```
3. Load the Docker images as follows:
   ...
   ```bash
    ...
    docker load -i D_k2view_fabric_6.5.9_220.tar.gz 
   ```
...
4. Untar the Config archives as follows:
   ...
   ```bash
   tar -zxvf compose_fabric_6.5.9_220.tar.gz
   ```
