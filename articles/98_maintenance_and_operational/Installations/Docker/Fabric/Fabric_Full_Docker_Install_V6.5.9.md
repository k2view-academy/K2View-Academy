## FABRIC v6.5.9_100-HF2 DOCKER INSTALLATION
...
2. Retrieve the latest version of Kafka. The Kafka and configuration files can be retrieved from the following locations:
   ...
   <br>md5: 1aa20e26dfcf10a60bfc07451140ce2b</br></td>
   </tr>
   <tr>
   ...
   <br>md5: d29adcc78aabdf0bcfb5c6929c37c9ec</br></td>
   </tr>
   </tbody>
   </table>
3. Copy all files to the k2view directory as follows:
   ...
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_6.5/6.5.9/Server/fabric-6.5.9_100-HF2/D_k2view_fabric_6.5.9_100.tar.gz
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_6.5/6.5.9/Server/fabric-6.5.9_100-HF2/compose_fabric_6.5.9_100-HF2.tar.gz
   ```
4. Load the Docker images as follows:
   ...
   12 docker load -i D_k2view_cassandra_3.11.12.tar.gz 
    ...
    docker load -i D_k2view_fabric_6.5.9_100.tar.gz 
   ```
...
5. untar the Config archives as follows:
   ...
   ```bash
   tar -zxvf compose_fabric_6.5.9_100-HF2.tar.gz 
   ```
...
1. Run docker-compose as follows:
   ...
   ```bash
   cd compose_fabric_6.5.9_100-HF2
   # run:  
   docker-compose up -d 
