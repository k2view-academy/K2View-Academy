## FABRIC V7.2.2_223-HF13 DOCKER INSTALLATION
...
1. Download the latest versions of Fabric, Cassandra and Docker Compose using 1 the below 4 links:
  ...
  <table style="border-collapse: collapse; width: 100%;">
   ...
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.2/7.2.2/Server/fabric-7.2.2_223-HF13/D_k2view_fabric_7.2.2_223.tar.gz
   <br>md5: 983846f7933c666a205649471bbd411a</br></td>
   </tr>
   <tr>
   <td style="width: 50%; height: 18px;"><strong>docker-compose </strong></td>
   <td style="width: 50%; height: 18px;">https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.2/7.2.2/Server/fabric-7.2.2_223-HF13/compose_fabric_7.2.2_223.tar.gz
...
```bash
   ...
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.2/7.2.2/Server/fabric-7.2.2_223-HF13/D_k2view_fabric_7.2.2_223.tar.gz
   wget https://owncloud-bkp2.s3.us-east-1.amazonaws.com/adminoc/fabricint/fabric_7.2/7.2.2/Server/fabric-7.2.2_223-HF13/compose_fabric_7.2.2_223.tar.gz
...
3. Load the Docker images as follows: (skip Kafka if not needed)
   ...
   ```bash
    ...
    docker load -i D_k2view_fabric_7.2.2_223.tar.gz 
   ```
...
4. Extract the Config archives as follows:
   ...
   ```bash
   tar -zxvf compose_fabric_7.2.2_223.tar.gz 
   ```
