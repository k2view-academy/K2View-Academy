...
2. Edit the Fabric project before deploying the TDM library to Fabric:
   ...
   - New TDM  installation: edit the project as follows, to create the TDM tables on the PostgreSQL TDM DB:
     ...
     - Note that the TDM DB and user must be created in advance in the PostgreSQL DB. For more information see [TDM Installation and Initial Configuration](/articles/98_maintenance_and_operational/Installations/TDM/TDM_Installation_V9.0.md).
