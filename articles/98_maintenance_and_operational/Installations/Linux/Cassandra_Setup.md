...
**Note**: If you decide to change the password from the above example, note that you will need to update it later in point that you preconfigure the Fabric. We refer the the following SED lines:
