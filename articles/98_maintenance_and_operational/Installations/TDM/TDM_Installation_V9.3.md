...
- Use the **Custom Import** option — right-click on the root of the Project Tree, click on Import and then click Custom Import — to import the TDM Library export file in order to import the TDM utils into your project.
