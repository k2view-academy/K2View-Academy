...
- **Fabric Server** - TDM 9.1 works with Fabric 8.1 and above. Read [here](/articles/98_maintenance_and_operational/Installations/Docker/Fabric/README.md).
...
- For more details, read [TDM Upgrade Document](/Release_Notes_And_Upgrade/TDM-V9.1/TDM_Upgrade_Procedure_to_V9.1.pdf).
...
Open the Fabric 8.1 Web Studio, click the Extension icon, and select TDM to install the TDM 9.1 library.
