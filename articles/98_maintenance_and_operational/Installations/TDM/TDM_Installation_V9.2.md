...
- **Fabric Server** - TDM 9.2 works with Fabric 8.1 and above. Read [here](/articles/98_maintenance_and_operational/Installations/Docker/Fabric/README.md).
...
Click here to open the [TDM 9.2 Docker Installation document](/articles/98_maintenance_and_operational/Installations/Docker/TDM/TDM_Docker_Installation_V9.2.md).
...
Download the TDM Library from the [download links]([TDM 9.2.0_download_links.docx](https://k2view.sharepoint.com/:w:/r/sites/KS/_layouts/15/Doc.aspx?sourcedoc=%7B9C259AC2-1FA9-45EA-94CB-C42B81E21AC2%7D&file=TDM%209.2.0_download_links.docx&action=default&mobileredirect=true), import and deploy it. Use the Import All option to import the TDM LU.
...
- For more details, read [TDM Upgrade Document](/Release_Notes_And_Upgrade/TDM-V9.2/TDM_Upgrade_Procedure_to_V9.2.pdf).
...
Open the Fabric 8.1.5 Web Studio, click the Extension icon, and select TDM to install the TDM 9.2 library.
