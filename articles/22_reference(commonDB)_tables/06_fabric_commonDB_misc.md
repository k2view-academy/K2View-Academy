...
Note that in both cases, depending on the size of the update, the table's content is synced from either the Kafka message payload or the System DB schema.
