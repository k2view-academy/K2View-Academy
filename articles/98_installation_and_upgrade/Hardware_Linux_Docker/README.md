...
<ul>
  ...
  <li>
    <a href="/articles/98_installation_and_upgrade/Hardware_Linux_Docker/02_hardware_req_for_dev_qa.md">
      Dev and QA Environment System Requirements
    </a>
  </li>
  <li>
    <a href="/articles/98_installation_and_upgrade/Hardware_Linux_Docker/03_hardware_req_for_prod.md">
      Production Environment System Requirements 
    </a>
  </li>
</ul>
