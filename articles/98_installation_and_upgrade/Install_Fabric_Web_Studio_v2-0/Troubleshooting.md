...
<ul>      
   <li><a href="/articles/98_installation_and_upgrade/Install_Fabric_Web_Studio_v2-0/Troubleshooting.md#command-failures">Command Failures</a></li>
   <li><a href="/articles/98_installation_and_upgrade/Install_Fabric_Web_Studio_v2-0/Troubleshooting.md#slow-performance-using-wsl">Slow Performance Using WSL</a></li>
   <li><a href="/articles/98_installation_and_upgrade/Install_Fabric_Web_Studio_v2-0/Troubleshooting.md#system-cannot-find-the-file-specified">System cannot find the file specified</a></li>
   <li><a href="/articles/98_installation_and_upgrade/Install_Fabric_Web_Studio_v2-0/Troubleshooting.md#connect-permission-denied">Connect Permission Denied</a></li>
   <li><a href="/articles/98_installation_and_upgrade/Install_Fabric_Web_Studio_v2-0/Troubleshooting.md#404-and-502-errors">404 and 502 Errors</a></li>
</ul>
...
Starting Docker and its Docker Compose plugin depends on the operating system you use. Please refer to the <a href="/articles/98_installation_and_upgrade/Install_Fabric_Web_Studio_v2-0/6-Docker-Compose.md#install-docker-and-docker-compose-on-linux-macos-or-microsoft-windows">Docker and Docker Compose Installation</a> topic.
