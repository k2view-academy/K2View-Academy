...
Fabric supports, since v6.5.9 release, integrations with KMS (Key Management Services) in order to generate and encrypt its master key.  
...
* [AWS](https://aws.amazon.com/kms/) - the application calls to KMS to generate a data key and it then gets the data key back in its 2 forms. 
