...
* GCP, Supports multi regional, as well as a "general" region. Best practice recommendations are descried and [here](https://cloud.google.com/kms/docs/locations#choosing). 
