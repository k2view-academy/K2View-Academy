...
The secrets, like passwords, which are part of the interfaces definitions, are stored securely, either at Fabric, where secrets are encrypted or at external secret manager service which Fabric integrates with.
