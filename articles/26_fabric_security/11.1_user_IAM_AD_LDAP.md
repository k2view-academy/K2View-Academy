...
For more information about how Fabric works with LDAP, read [here](/articles/26_fabric_security/11_user_IAM_LDAP.md). For more information about SAML configuration in Fabric, please read [here](/articles/26_fabric_security/13_user_IAM_configuration.md#ldap--ldaps-configuration).
