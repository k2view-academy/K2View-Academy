...
* **Certification** - SP and IDP provide each other its public key, which is used with their interactions. Their values are reflected and represented in Fabric [SAML configuration](/articles/26_fabric_security/13_user_IAM_configuration.md#saml-configuration) as SP_CERT_ALIAS and IDP_CERT_ALIAS. 
