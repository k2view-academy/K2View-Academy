...
creation_time: ```2020-08-12 12:20:07.894000+0000``` - timestamp of batch process creation.
end_time: ```2020-08-12 12:20:09.176000+0000``` - - timestamp for the end of batch process.
error: null
...
lut_name: ```AUTODATA_DELTA``` - name of LUT for which instances are being retrieved.
start_time: ```2020-08-12 12:20:07.907000+0000``` - timestamp for the start of batch process.
status: ```Done```
total_entities: ```200```
