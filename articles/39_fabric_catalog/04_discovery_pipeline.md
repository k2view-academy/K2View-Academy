...
The Discovery job is a pipeline that connects a series of steps where some are executed sequentially and some - in parallel. It has two main parts: Crawler and Plugin Framework.
