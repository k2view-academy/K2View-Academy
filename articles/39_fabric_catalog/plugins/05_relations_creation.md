...
Note: This plugin is active by default. If the plugin finds no redundant links to remove during the discovery execution, it will not appear in the **Discovery Monitor**.