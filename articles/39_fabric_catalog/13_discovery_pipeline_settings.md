...
The new plugin is always added to the end of the list. However, the plugin's execution order can be changed by dragging it to a required position in the list.  
