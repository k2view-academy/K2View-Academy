...
* **Filter** <img src="../images/filter.png" style="zoom:90%;" /> the Catalog graph by property. When a filter is set, the icon changes its color to orange. For more information about the Catalog filter, click [here](08a_filter_catalog.md). 
