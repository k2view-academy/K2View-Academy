...
To create Catalog artifacts, naviaget to **Actions > Build artifacts** in the [Menu bar](05_catalog_app.md#menu-bar). 

* You can build artifacts for a single data platform (either selected or expanded) or for the entire Catalog. 
* Once initiated, a progress popup appears in the bottom-right corner of the screen. Details about the progress bar can be found [further in this article](09_build_artifacts.md#build-artifacts-progress-bar).
* Note that building artifacts for a selected data platform and the progress bar feature are available starting from Fabric V8.4. 
