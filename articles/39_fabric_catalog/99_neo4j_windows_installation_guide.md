...
Download the link from [here](https://artifacts.share.cloud.k2view.com/k2view-neo4j/windows/k2view-neo4j-enterprise-5.26.20-windows.zip).

#### Unzip the package:
```powershell
Expand-Archive -Path .\k2view-neo4j-enterprise-5.26.20-windows.zip .
```

#### Remove zip file:
```powershell
Remove-Item -Path .\k2view-neo4j-enterprise-5.26.20-windows.zip
```
