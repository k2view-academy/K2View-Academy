...
Moreover, the Data Viewer provides another mode, named "New", that when selected, the LU Instance is first deleted and then instance is brought from scratch. (Such option also appears in Broadway Debug Population *Mode*).
