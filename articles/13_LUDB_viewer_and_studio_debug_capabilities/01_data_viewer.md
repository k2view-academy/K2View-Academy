...
Moreover, the Data Viewer provides another mode, named "New", that when selected, the LU Instance is first deleted and then Instance is brought from scratch. (Such an option also appears in Broadway Debug Population *Mode*).
