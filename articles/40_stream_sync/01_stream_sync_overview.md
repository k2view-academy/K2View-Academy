...
* Synchronization by request, which is based on a predefined sync method and the sync mode. [Click here to get more information about Sync LUI by request, various sync modes and sync methods](/articles/14_sync_LU_instance/01_sync_LUI_overview.md).
