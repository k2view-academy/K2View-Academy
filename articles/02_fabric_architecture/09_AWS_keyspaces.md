...
* TTL (time-to-live) mechanism is not automatically supported in AWS keyspaces. Thus after the table is created, it should be altered in order to activate the TTL support. 
