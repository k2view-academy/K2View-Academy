...
Starting from V7.2, SQLite and PostgreSQL are also supported as operational DB. The settings are done via the new [internal_db] section of config.ini. [Click to learn how to switch to SQLite or PostgreSQL as operational DB](/articles/06_cassandra_keyspaces_for_fabric#How-to-Switch-to-SQLite-or-PostgreSQL).
