...
It is strongly recommended to use the Business Entity on PostgreSQL capability, which stores all the Logical Unit data in PostgreSQL while indexing the data by the entity ID. 
