...
Fabric supports the ability to set the session variables on the Fabric Connection URL using the following syntax:

* jdbc:fabric://localhost:port?user=admin&password=admin&timeout=0&sync=off&test=testValue
