...
This is the **default option**. Populate the list of entities for the task, and separate the entities with a comma. Note that a warning is given if the entity list contains entities that are reserved for another user.
