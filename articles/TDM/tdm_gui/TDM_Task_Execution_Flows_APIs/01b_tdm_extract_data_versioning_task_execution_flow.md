# TDM - Extract with Data Versioning (Data Flux) Task Flow
...
[<img src="images/task_get_retention_period.png" alt="drawing" width="200pxl" style="zoom:80%;" />](10_retention_period_APIs.md) Get the retention period options for the extracted data version.
...
[<img src="images/task_validate_retention_period_on_extract.png" alt="drawing" width="200pxl" style="zoom:80%;" />](10_retention_period_APIs.md) Validate the retention period if the user is added as a tester to the target environment.
