...
- Click the Edit icon to populate the parameters for the process. A pop-up window opens with the process' parameters. Mandatory input parameters are marked with a red asterisk. Populate the parameter values for the task:
