...
- The Replace Sequence must be implemented in the [Fabric implementation](/articles/tdm_implementation/11_tdm_implementation_using_generic_flows.md#step-4---create-the-sequence-creation-flows). 
