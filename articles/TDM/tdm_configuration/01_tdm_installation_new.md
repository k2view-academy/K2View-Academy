...
- **PostgreSQL DB** - the TDM DB tables are created on a PostgreSQL DB. Note that you can either use a PostgreSQL v9.6 or v13 versions. see [here](/articles/TDM/tdm_configuration/01_tdm_installation_new.md)
