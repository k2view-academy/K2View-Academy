...
### Cleanup Process 
The cleanup process of both the AI execution server and the AI DB is manual, and it runs a dedicated flow. Click [here](articles/98_maintenance_and_operational/Installations/TDM/TDM_AI_Installation_V9.0.md#manual-cleanup-flow) for more information about the AI cleanup process.
