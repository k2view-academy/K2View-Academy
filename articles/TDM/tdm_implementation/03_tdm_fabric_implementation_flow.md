...
1. Optional - [Fabric Catalog](/articles/39_fabric_catalog/01_catalog_overview.md) - 
...
2. [Logical units (LUs) creation](05_tdm_lu_implementation_general.md)

3. Adding a TDM setup to the LUs:
...
4. Optional - Synthetic data implementation:
