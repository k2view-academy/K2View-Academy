...
From TDM 7.6 onwards, the TDM supports running extract and load tasks on Reference tables, i.e., the task extracts from the source environment into Fabric and loads it into the target environment. 
