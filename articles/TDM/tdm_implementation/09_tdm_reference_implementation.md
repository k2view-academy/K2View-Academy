...
The user can store the tables in Fabric for a later use or set the task's retention period to *Do not retain* to load the tables directly to the target environment without saving them to Fabric.
