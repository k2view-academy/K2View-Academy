...
- The overridden fields must be added to a Map. The Map needs to be sent as a parameter to the **Merge Maps of all Fields** Actor in the data generation flow.
...
- TDM 8.1 has added a new Actor: **GenerateConsistent**. This Actor inherits the **Masking** Actor, but it has its own **category** value: **generate_consistent**. Using this Actor in the data generation flow enables the following:
