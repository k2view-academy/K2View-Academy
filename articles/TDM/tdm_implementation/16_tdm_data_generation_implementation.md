...
- TDM 8.1 has added a new Actor — **GenerateConsistent**. This Actor inherits the **Masking** Actor, but it has its own **category** value — **generate_consistent**. Using the **GenerateConsistent** Actor in data generation flow ensures referential integrity across LUs for the generated field.
- Notes:
