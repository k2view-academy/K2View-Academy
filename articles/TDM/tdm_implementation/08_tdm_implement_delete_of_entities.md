...
The target LU tables and delete flows are automatically generated by the [TDMLuInitBasedOnFabric flow](05_tdm_lu_implementation_general.md#ii-adding-the-tdm-setup-to-the-lu) when the **CREATE_DELETE_TABLES** input parameter is set to **true**.
