...
Fabric 8.2 has added the [catalog's sequence setting](/articles/39_fabric_catalog/10_catalog_settings.md#sequences-tab). The following section describes both methods of sequence handling implementation:
