...
- Both of the above-mentioned sequence methods require the creation of the **k2masking** schema. The k2masking schema is created by the TDM deploy.flow. Alternatively, could run the **masking-create-cache-table.flow** from the Broadway examples. 
