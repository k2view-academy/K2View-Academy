...
- **Create Synthetic Entities**, create duplications on the target environment of the  Entity ID, set in the task. Note that only one LUI is created on the entity ID.
