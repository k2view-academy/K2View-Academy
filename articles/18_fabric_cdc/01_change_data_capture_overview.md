...
- When the LU is redeployed to Fabric, a [CDC Schema Update](03_cdc_messages.md#cdc-schema-update) message is published to Kafka, informing about the schema's updates in the affected CDC LU tables.
