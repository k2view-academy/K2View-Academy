...
- [Data Editor](04_data_editor_overview.md) - a web utility for viewing and editing Fabric [LU](/articles/06_LU_tables/01_LU_tables_overview.md) and [refences](/articles/22_reference(commonDB)_tables/01_fabric_commonDB_overview.md) data. Data Editor also shows the data structure and relationships between the tables within a Fabric LU scheme.
