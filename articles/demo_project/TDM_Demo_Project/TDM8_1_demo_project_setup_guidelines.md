...
7. Deploy the LUs, Reference, and Web Services to Fabric. Note that you must deploy the Environments *before* running Data Viewer on the LUs since the main Target LU table sets the target ('TAR') environment to be the active environment.
