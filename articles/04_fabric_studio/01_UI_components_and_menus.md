...
* **Create new** Fabric project's entities (some of these actions are also available in the Project Tree's context menu):
  ...
  * New Java Function - lets you easily create either a [Fabric function type](/articles/07_table_population/08_project_functions.md), like Event, Decision, Trigger or LUDB, as well as a regular function. When Fabric function is selected, then it will be created with relevant decelerations and format.
