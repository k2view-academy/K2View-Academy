...
* **Create new** Fabric project's entities (some of these actions are also available in the project tree's context menu):
  ...
  * New Java Function - lets you to easily create either a [Fabric function type](/articles/07_table_population/08_project_functions.md), like Event, Decision, Trigger, or LUDB, as well as a regular function. When Fabric function is selected then it will be crated with relevant decelerations and format.
