...
To initiate an action, right-click on a component and select the action. As this is a context menu, then in each component and level, different options will be shown. For instance, right-clicking on Broadway offers the creation of a new flow or an Actor. 
