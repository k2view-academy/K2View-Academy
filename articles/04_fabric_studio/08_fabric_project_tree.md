...
* **Logical Units / Data Products** - a collection of all defined [Logical Units / Data Products](/articles/03_logical_units/01_LU_overview.md) in the project. Of this collection, there are 2 *system* logical units - **References** and **Web Services** - that exist by default in any project:
