...
* DEV 2 is assigned to implement the hotfix and he switches to work on a version based on a tag (by doing it he detached from tag and needs to make his changes on a some branch).
