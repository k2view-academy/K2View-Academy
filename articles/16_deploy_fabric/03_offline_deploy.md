...
Deploying into non-development servers shall be carefully done, verifying that the right changes will be applied. Verification can be human code-reviews, as well as tools the perform 3rd-party dependency vulnerability checks and code analysis for quality & security. 
