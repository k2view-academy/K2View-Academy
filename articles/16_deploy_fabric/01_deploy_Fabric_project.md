...
- Each deployed LU creates a new System DB **schema** named **k2view_[LU Name]_[cluster id if exists]**.
- The first deployed Web Service creates a new System DB **schema** named **k2view_k2_ws**.
