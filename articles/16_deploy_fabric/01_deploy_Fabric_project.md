...
The tag version creation is done along with GIT tagging capability, so that a project version is preserved both as a property in the project definitions file (k2proj.xml) and as a GIT annotated tag.
