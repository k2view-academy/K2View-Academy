...
In the Studio's User Preferences screen, you can choose, per remote server, at the **Pre Deploy Tag Validation** field, whether to skip it, to warn when validation failed or block the deployment when validation failed.
