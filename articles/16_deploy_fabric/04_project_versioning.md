...
Fabric Studio allows to deploy project objects into remote servers. As part of project versioning capability, Studio offers you to decide, per remote server, weather activating the version tag validation, as a pre-deploy step, ensuring by doing it that you will have the most exact visibility on what is deployed at the target remote Fabric server. 
