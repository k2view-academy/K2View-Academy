...
This permission is needed to generate a new key when using Fabric's [key generator](/articles/26_fabric_security/02_fabric_entities_design.md#master-key-commands) capability
