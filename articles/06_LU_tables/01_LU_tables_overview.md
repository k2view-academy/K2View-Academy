...
-  _**k2_main_info**, which stores the synced LU instance version and the last sync time.
  ...
  <td width="700pxl" valign="top"> 
   <p>LU instance's last sync timestamp</p>
  </td>
  </tr>
  </table>
...
-  _**k2_objects_info**, which stores LU instance statistics on an object population or enrichment function level.
  ...
  <td width="700pxl" valign="top"> 
   <p>Last time the object was verified to be synced</p>
  </td>
  </tr>
  <tr>
  <td  width="200pxl" valign="top">
  ...
  <td width="700pxl" valign="top"> 
   <p>Start time of last write LU instance into the SQLite file</p>
  </td>
  </tr>
  <tr>
  <td  width="200pxl" valign="top">
  ...
  <td width="700pxl" valign="top"> 
   <p>End time of last write LU instance into the SQLite file</p>
  </td>
  </tr>
  <tr>
  <td  width="200pxl" valign="top">
  ...
  <td width="700pxl" valign="top"> 
   <p>Version Id of the last object's sync</p>
  </td>
  <tr>
  <td  width="200pxl" valign="top">
  <p>sync_error</p>
