...
*	[CDC Topic](/articles/18_fabric_cdc/03_cdc_consumers_implementation.md), holding a list of fields to be published to an external system (CDC topic) using the CDC mechanism.
