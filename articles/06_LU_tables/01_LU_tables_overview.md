...
-  **_k2_main_info**, which stores the last deployed LU version and the last sync instance.
  ...
  <td width="700pxl" valign="top"> 
   <p>Timestamp of the LU schema last deploy</p>
  </td>
  </tr>
  </table>
...
-  **_k2_objects_info**, which stores the LU instance's statistics.
  ...
  <td width="700pxl" valign="top"> 
   <p>Version of the object's schema</p>
  </td>
  <tr>
  <td  width="200pxl" valign="top">
  <p>sync_error</p>
