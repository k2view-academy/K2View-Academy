...
To remove a table from the LU schema, open the [**LU Schema window**](https://github.com/k2view-academy/K2View-Academy/wiki/Logical-Unit-Schema-Window), click the **Table**, press the **Delete** key and save the changes.
