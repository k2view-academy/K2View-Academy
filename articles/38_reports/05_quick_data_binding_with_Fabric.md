...
The article [Data Binding](03_data_binding.md) describes all the steps needed to configure a data source and a data set in report. In addition, there is a quick way to configure the data binding with Fabric built-in endpoints. The following steps describe how to do it:
