...
Now, click anywhere on the gray area surrounding the report in order to load the report's properties in the **Properties Panel**. Here you can set various report level properties, such as layout.

![](images/02_create_new_rep_01.png)

The Advanced properties can be revealed via the 3 dots icon located in the **Properties Panel**:
