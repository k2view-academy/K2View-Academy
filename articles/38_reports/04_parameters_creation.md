...
Additionally, you can define the list of the parameter's valid values and/or a default value. Both can either come from a data set or use 'hardcoded' values.
