...
Advanced error handling features can be implemented using an **ErrorHandler** and **ErrorFields** Actors that enable configuring different types of behavior depending on the exception type. To learn about the advanced error handling options, refer to the [Error Handling Actors](actors/06_error_handling_actors.md) article.
