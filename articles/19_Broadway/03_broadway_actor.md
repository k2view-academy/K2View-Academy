...
Note that you can add a call to an inner flow by switching the radio button from **Actors** to **Flows** in the pop-up screen and selecting a flow. An **InnerFlow** Actor is then added to the flow, and it includes the selected flow. [Click for more information about Inner Flows.](22_broadway_flow_inner_flows.md)
