...
To invoke the Broadway profile rwhen running the flow using the **broadway** command, set **profilerTelemetry** to **true** . This will add the profiler results to the command results.
