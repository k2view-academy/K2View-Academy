...
<p>Click <img src="images/99_favorites.PNG" alt="lev" /> in Actor's desription in the Add Actors window to add an Actor to Favoties.</p>
<p>The Actor that belongs to Favorites displays <img src="images/99_favorites1.PNG" alt="lev" />.</p>
</td>
