...
<td style="vertical-align: top; height: 242px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>Favorites</strong>&nbsp;</p>
<p><span style="text-decoration: underline;">Description</span>: Most commonly used Actors.</p>
...
<td style="vertical-align: top; height: 242px; width: 193.328px;">
...
<p><span style="text-decoration: underline;">Category Name</span>:<strong>basic</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Actors serve as the basic building blocks for creating a Broadway flow.</p>
</td>
<td style="vertical-align: top; height: 247px; width: 193.328px;">
...
<td style="vertical-align: top; height: 82px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>data</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Various data manipulations, such as accumulate values into a map, build an array or sort the input collection.</p>
</td>
<td style="vertical-align: top; height: 82px; width: 193.328px;">
...
<td style="vertical-align: top; height: 270px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>date/time</strong></p>
<p><span style="text-decoration: underline;">Description</span>:Various Date and Time manipulation functions, such as DateAdd, DateFormat or Now.</p>
</td>
<td style="height: 270px; width: 193.328px;">
...
<td style="vertical-align: top; height: 411px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>db</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Actions to be performed on a DB interface, such as creating a new table, loading data or executing a DB command.</p>
</td>
<td style="width: 193.328px; vertical-align: top; height: 411px;">
...
<td style="vertical-align: top; height: 165px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>fabric</strong></p>
<p><span style="text-decoration: underline;">Description: </span>Actors which execute the Fabric commands.</p>
</td>
<td style="width: 193.328px; vertical-align: top; height: 165px;">
...
<td style="vertical-align: top; height: 133px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>images</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Image manipulation Actors that allow to perform various activities, such as:</p>
<ul>
...
<td style="width: 193.328px; vertical-align: top; height: 133px;">
...
<p><span style="text-decoration: underline;">Category Name</span>: <strong>jobs</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Actors that creates Fabric jobs.&nbsp;</p>
</td>
...
<td style="vertical-align: top; height: 205px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>logic</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Logical operation on Actors<strong> A</strong> and <strong>B</strong> which returns a <strong>True</strong> or <strong>False</strong> boolean result.</p>
...
<td style="width: 193.328px; vertical-align: top; height: 205px;">
...
<tr style="height: 165px;">
<td style="vertical-align: top; height: 165px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>masking</strong></p>
<p><span style="text-decoration: underline;">Description</span>: A group of Actors to mask sensitive information, such as SSN, credit card number, email. It also includes the Actors that can define a sequence.</p>
</td>
<td style="width: 193.328px; vertical-align: top; height: 165px;">
...
<td style="width: 169.672px; vertical-align: top; height: 169px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>math</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Various mathematical functions, such as MathMax, MathMin, Aggregate.</p>
</td>
<td style="height: 169px; width: 193.328px;">
...
<td style="height: 100px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>parsers</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Various parsers which can be received as input stream in different types of formats, for example, CSV, JSON or XML.</p>
</td>
<td style="height: 100px; width: 193.328px;">
...
<tr style="height: 133px;">
<td style="height: 133px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>queue</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Publish / subscribe messages to the queue.</p>
</td>
<td style="width: 193.328px; vertical-align: top; height: 133px;">
...
<td style="height: 284px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>stats</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Actors that gather the flow statistics.</p>
</td>
...
<td style="height: 292px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>streams</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Various stream manipulation functions, such as Compress, FileRead or Http.</p>
</td>
<td style="height: 292px; width: 193.328px;">
...
<td style="vertical-align: top; height: 379px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>strings</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Various string manipulation functions, such as Concat, Split or Trim.</p>
<p>Graphit and JsonStringify Actors are also included in this category.</p>
</td>
<td style="height: 379px; width: 193.328px;">
...
<td style="vertical-align: top; height: 215px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>system</strong></p>
<p><span style="text-decoration: underline;">Description</span>: System processes and commands to be performed in the file system.</p>
</td>
<td style="height: 215px; width: 193.328px;">
...
<td style="vertical-align: top; height: 229px; width: 169.672px;">
<p><span style="text-decoration: underline;">Category Name</span>: <strong>testing</strong></p>
<p><span style="text-decoration: underline;">Description</span>: Actors that check a condition and throw an assersion exception if the condition is not met.</p>
</td>
<td style="height: 229px; width: 193.328px;">
